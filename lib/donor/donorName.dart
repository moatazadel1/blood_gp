...
import 'package:blood_gp/donor/LastName.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:progress_line/progress_line.dart';

class Donorname extends StatefulWidget {
  const Donorname({super.key});

  @override
  State<Donorname> createState() => _DonornameState();
}

class _DonornameState extends State<Donorname> {
                      ...
                      Form(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            onChanged: (value) {
                              setState(() {
                                _Donorname.text = value;
                              });
                            },
                            onSaved: (newValue) {
                              setState(() {
                                _Donorname.text = newValue.toString();
                              });
                            },
                            validator: (value) {
                              if (value!.isEmpty) {
